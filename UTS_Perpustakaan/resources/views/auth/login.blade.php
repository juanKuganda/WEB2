<x-authLayout title="Login" section_title="Welcome Back" section_description="Login with your account">
  @if (session('success'))
  ...
  <form action="{{ route('auth.authenticate') }}" method="POST" class="flex flex-col gap-4 mt-2 text-black">
      ...
      <button type="submit"
              class="bg-red-500 border text-white px-3 py-2 text-center gap-2 cursor-pointer mt-4">
          <span>Login</span>
      </button>
